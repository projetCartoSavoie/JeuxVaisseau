...
void transformationUtilisateur(point3d* P, double ri, double rj, double rv, double ti, double tj) {
     ...
     */
     int i;
     double matriceRotationV[3][3];
     double matriceRotationJ[3][3];
     double matriceRotationI[3][3];
     ...
     //Init rotation matrix on axe X
     matriceRotationV[0][0] = 1;
     matriceRotationV[0][1] = 0;
     matriceRotationV[0][2] = 0;
     matriceRotationV[1][0] = 0;
     matriceRotationV[1][1] = cos ( rv * PI / 180.0 );
     matriceRotationV[1][2] = - sin ( rv * PI / 180.0 );
     matriceRotationV[2][0] = 0;
     matriceRotationV[2][1] = sin ( rv * PI / 180.0 );
     matriceRotationV[2][2] = cos ( rv * PI / 180.0 );
     
     
     //Init rotation matrix on axe y
     matriceRotationJ[0][0] = cos ( rj * PI / 180.0 );
     matriceRotationJ[0][1] = 0;
     matriceRotationJ[0][2] = sin ( rj * PI / 180.0 );
     matriceRotationJ[1][0] = 0;
     matriceRotationJ[1][1] = 1;
     matriceRotationJ[1][2] = 0;
     matriceRotationJ[2][0] = - sin ( rj * PI / 180.0 );
     matriceRotationJ[2][1] = 0;
     matriceRotationJ[2][2] = cos ( rj * PI / 180.0 );
     
     
     //Init rotation matrix on axe y
     matriceRotationI[0][0] = cos ( ri * PI / 180.0 );
     matriceRotationI[0][1] = - sin ( ri * PI / 180.0 );
     matriceRotationI[0][2] = 0;
     matriceRotationI[1][0] = sin ( ri * PI / 180.0 );
     matriceRotationI[1][1] = cos ( ri * PI / 180.0 );
     matriceRotationI[1][2] = 0;
     matriceRotationI[2][0] = 0;
     matriceRotationI[2][1] = 0;
     matriceRotationI[2][2] = 1;
     ...
     for (i = 0; i < 24; i++) {
			mul_pt3d_matrice(P[i], matriceRotationV);
			mul_pt3d_matrice(P[i], matriceRotationJ);
			mul_pt3d_matrice(P[i], matriceRotationI);
